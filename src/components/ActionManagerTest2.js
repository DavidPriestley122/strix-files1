...
function OwlMaker(name, Position, TeamMat) {
   const pieceNew = MeshBuilder.CreateCylinder(name, {height: 7, diameter: 0.5, subdivisions: 7, });
   pieceNew.position = Position 
...
if(j%2 ===0 && i%2 ===0){
const box = i === 0? MeshBuilder.CreateBox("box0", {width: 1, height: 0.5}, Box.getScene()) : MeshBuilder.CreateBox("box0", {width: 1, height: 0.5}, Box.getScene());
...
if(pieceIndex===1) {  
OwlMaker("brownOwl", new Vector3(box.position.x, box.position.y+3.75, box.position.z), brownTeamMat)
 


/*const pieceNew = MeshBuilder.CreateCylinder('brownOwl', {height: 7, diameter: 0.5, subdivisions: 7, });
pieceNew.position = new Vector3(box.position.x, box.position.y+3.75, box.position.z)
const owlMat = new StandardMaterial("owlMat")
owlMat.diffuseColor = Color3.FromInts(204,153,102);
const multiMat = new MultiMaterial("multi")
multiMat.subMaterials.push(owlMat);
...
const pieceNew = MeshBuilder.CreateCylinder('brownKite', {height: 7, diameter: 0.5, subdivisions: 7, });
pieceNew.position = new Vector3(box.position.x, box.position.y+3.75, box.position.z)
...
const pieceNew = MeshBuilder.CreateCylinder('brownRaven', {height: 7, diameter: 0.5, subdivisions: 7, });
pieceNew.position = new Vector3(box.position.x, box.position.y+3.75, box.position.z)
...
const pieceNew = MeshBuilder.CreateCylinder('yellowOwl', {height: 7, diameter: 0.5, subdivisions: 7, });
pieceNew.position = new Vector3(box.position.x, box.position.y+3.75, box.position.z)
const owlMat = new StandardMaterial("owlMat")
owlMat.diffuseColor = Color3.FromInts(204,153,102);
const multiMat = new MultiMaterial("multi")
...
multiMat.subMaterials.push(owlMat);
multiMat.subMaterials.push(owlMat);
multiMat.subMaterials.push(yellowTeamMat);
pieceNew.subMeshes = [];
let verticesCount = pieceNew.getTotalVertices();
console.log(verticesCount)
pieceNew.subMeshes.push(new SubMesh(0,0,verticesCount,0,144,pieceNew))
...
const pieceNew = MeshBuilder.CreateCylinder('yellowKite', {height: 7, diameter: 0.5, subdivisions: 7, });
pieceNew.position = new Vector3(box.position.x, box.position.y+3.75, box.position.z)
const kiteMat = new StandardMaterial("kiteMat") 
kiteMat.diffuseColor = Color3.FromInts(139,0,0);
const multiMat = new MultiMaterial("multi")
...
if (j%2!==0 && i%2!==0){
const box = i === 0? MeshBuilder.CreateBox("box0", {width: 0, height:0.5}, Box.getScene()) : MeshBuilder.CreateBox("box0", {width: 1, height: 0.5}, Box.getScene());
...
pieceNew.position = new Vector3(box.position.x +3.75, box.position.y, box.position.z)
pieceNew.rotation = new Vector3(0, 0, -Math.PI/2)
...
pieceNew.position = new Vector3(box.position.x, box.position.y, box.position.z+3.75)
pieceNew.rotation = new Vector3(Math.PI/2, 0,0)
...
export const ActionManagerTest2= () => (
...
<directionalLight  name="dl"  intensity={2}  direction={new Vector3(-3,-5,-3)}  position={new Vector3(5, -5, -5)} />
