  ...
  /* // this connects the board squares
   function TheBoard1(){
    ...
    for (let i = 1  ; i <= count ; i++) {
        const key = `${i}`;
        if(i%2===0)
        joinedBoard.push(SingleBoardSquare(squareColor1))
    if(i%2!==0)
        joinedBoard.push(SingleBoardSquare(squareColor2))
   }
   */
 ...
 export const NewCBoard4 = () =>(  
       ...
       <div style={{flex: 1, display: 'flex'}}>
        ...
        <hemisphericLight name='light2' intensity={.7} direction={Vector3.Down()} />
         ...
         <SingleBoardSquare  diffuseColor = {squareColor(0,255,0)}/>
